...
Every Sudoku-like puzzle can be reduced to an {http://en.wikipedia.org/wiki/Exact_cover exact cover problem}.  From there is can be efficiently solved with the {http://arxiv.org/abs/cs/0011047 Dancing Links} algorithm discovered by Donald Knuth.  That is the main purpose of this gem.
...
You are invited to fork the {https://github.com/DavidEGrayson/doku Doku github repository} and work on improving the gem.
